                  ...
                  <template v-slot:default="props">
                    <v-list dense v-for="item in props.items" :key="item.bookImg">
                      ...
                      <v-list-item v-if="item.realReturn">
                        <v-list-item-subtitle>실제 반납 일:</v-list-item-subtitle>
...
export default {
  ...
  created() {
    this.bookRentId = window.sessionStorage.getItem("bookRentId");
    
    this.getAxios.get("/admin/book/return/detail/" + this.bookRentId, this.requestHeader)
      .then(res => {
